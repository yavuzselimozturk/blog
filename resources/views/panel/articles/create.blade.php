    ...
    <div class="card-body">
      ...
      <form method="post" action="{{route('makaleler.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="baslik" class="form-control" required></input>
        ...
        <div class="form-group">
          ...
          <input type="file" name="resim" class="form-control" required></input>

        </div>
        <div class="form-group">
          <label>Makale İçeriği</label>
          <textarea id="editor" name="content" class="form-control" rows="8" required></textarea>
